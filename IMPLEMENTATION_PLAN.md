...
|---|---|---|
| 15b — Walk-forward + minimal UI | 2.5 d | 2.5 d |
| 15c — Metrics + attribution | 1.5 d | 4 d |
| 15d — Charts + polish | 1.5 d | 5.5 d |

**~5.5 days remaining.** 15a shipped (see [`DONE.md`](./DONE.md)).
...
**Done so far:** ~49 days of build time across Phases 0–14 + 15a. Per-phase effort breakdowns live in [`DONE.md`](./DONE.md).

### 🚧 Remaining (priority order)

| # | Phase | Effort | Cumulative remaining |
|---|---|---|---|
| 15b | Backtest — walk-forward + minimal UI | 2.5 d | 2.5 d |
| 15c | Backtest — metrics + attribution | 1.5 d | 4 d |
| 15d | Backtest — charts + polish *(GATE clears here)* | 1.5 d | 5.5 d |
| 16 | Paper trading | 4 d (+ 12 mo soak) | 9.5 d |
| 16.1 | Paper-trade carve-out for audit-log prune | 0.5 d | 10 d |
| 17 | Postgres migration | 1.5 d | 11.5 d |
| 18 | Decay monitoring | 3 d | 14.5 d |
| 19 | Alternative data | 5 d | 19.5 d |
| 20 | Portfolio optimization | 5 d | 24.5 d |
| 21 | Cost-bearing AI *(gated on 15d)* | 3–15 d | up to 39.5 d |

**~5.5 days to reach Phase 16** (paper trading), then **~5 weeks** of remaining build before the 12-month soak begins. Phase 15 (split 15a–d, 15a done) is the gate that unlocks weight re-tuning, Phase 16 (paper trading), and Phase 21 (LLM enhancements).
